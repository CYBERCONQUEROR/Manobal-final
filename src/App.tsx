...
import ProfessionalSelection from './components/ProfessionalSelection'; // Import the new component
  ...
  return (
    <div className="min-h-screen transition-colors">
      ...
      <Routes>
        ...
        <Route path="/select-professional" element={<ProfessionalSelection />} /> {/* New Professional Selection Route */}
        {user.role === 'admin' && (
